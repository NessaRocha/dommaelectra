        ...
        <div className={`content ${animar ? "animar" : ""}`}>
          <div className="header-section">
            ...
            <p className="description">
              Nem toda casa é igual. Nem todo morador tem os mesmos hábitos. Por isso, 
              sua automação precisa ser feita sob medida, com soluções inteligentes 
              adaptadas ao que realmente faz sentido pra você.
            </p>
          </div>
          ...
          <div className="solutions-grid">
            <div className="solution-card">
              ...
              <p>
                Som ambiente, controle de iluminação por sala, agendamento de abertura 
                de cortinas e climatização personalizada para cada ambiente.
              </p>
            </div>
            ...
            <div className="solution-card">
              ...
              <p>
                Evite alarmes falsos com sensores adaptados para cachorros e gatos. 
                Automatize alimentação, climatização e conforto para os bichinhos.
              </p>
            </div>
            ...
            <div className="solution-card">
              ...
              <p>
                Iluminação noturna automática, alarmes silenciosos de emergência, 
                sensores de queda e ambientes mais seguros.
              </p>
            </div>
            ...
            <div className="solution-card">
              ...
              <p>
                Acorda cedo? A casa se prepara pra você. Trabalha em turnos? 
                A iluminação e temperatura se ajustam à sua rotina.
              </p>
            </div>
            ...
            <div className="solution-card">
              ...
              <p>
                Sala que vira home office de dia e cinema à noite? Com um botão, 
                o espaço muda com iluminação, som, cortinas e temperatura ideais.
              </p>
            </div>
            ...
            <div className="solution-card highlight">
              ...
              <p>
                Vamos até seu espaço, entendemos sua rotina, tiramos todas as dúvidas 
                e entregamos a melhor proposta técnica personalizada — sem custo e sem compromisso.
              </p>
            </div>
          </div>
